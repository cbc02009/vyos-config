...
set firewall name servers-containers rule 3 action 'accept'
set firewall name servers-containers rule 3 description 'Rule: accept_flexo'
set firewall name servers-containers rule 3 destination port '7878'
set firewall name servers-containers rule 3 protocol 'tcp'
...
set firewall name trusted-local rule 9 description 'Rule: accept_wireguard'
set firewall name trusted-local rule 9 destination port '51820'
